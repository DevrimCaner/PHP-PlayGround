        ...
        <div class="modal fade bg-blur" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog shadow">
                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5 text-primary" id="exampleModalLabel">Ders Ekle</h1>
        ...
        <table class="table table-hover shadow mt-4 rounded-4 text-primary">
            ...
            ?>
                ...
                <div class="modal fade bg-blur bg-danger bg-opacity-25" id="delete<?php echo $row['id'];?>" tabindex="-1">
                    ...
                    <div class="modal-content rounded-4">
                        <div class="modal-header">
                        <h5 class="modal-title fs-5 text-primary">Ders Silme</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <span class="text-primary fw-bold"><?php echo $row['name'];?></span> Dersini silmek istedğinize emin misniz ?
                        <p>
